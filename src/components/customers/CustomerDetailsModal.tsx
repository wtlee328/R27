              ...
              {activeContract ? (
                <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-6 relative overflow-hidden group">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <Badge className="bg-emerald-500 text-white border-none">進行中合約</Badge>
                  ...
                  <div className="grid grid-cols-3 gap-8">
                    <div>
                      ...
                      <p className="text-2xl font-black text-emerald-700">{activeContract.remainingSessions} / {activeContract.totalSessions}</p>
                    </div>
                    <div>
                    ...
                    <div className="text-right">
                      <Button variant="ghost" size="sm" onClick={() => onViewContract(customer, activeContract)} className="text-emerald-600 hover:text-emerald-700 hover:bg-emerald-100/50 gap-1 font-bold">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                          contract.status === 'active' ? 'bg-emerald-50 text-emerald-600' : 'bg-stone-50 text-stone-400'
                        }`}>
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <Badge variant={contract.status === 'active' ? 'default' : 'secondary'} className="text-[10px] py-0">
