    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-40 h-16 bg-white border-b border-stone-200/80 flex items-center px-4 sm:px-6 gap-3 shadow-2xs">
        ...
        <div className="flex items-center justify-center h-full">
          {centerId === 'r27' ? (
            <img src="/assets/logos/on-dark/logo-small.png" alt="R27" className="h-11 sm:h-12 w-auto max-h-[50px] object-contain brightness-0 shrink-0 select-none translate-y-[3px]" />
          ) : (
